...
public class PublishedEvent extends DomainChangeJdoAbstract implements HasTransactionId, HasUsername {
    ...
    public static abstract class PropertyDomainEvent<T>
            extends PublishingModule.PropertyDomainEvent<PublishedEvent, T> {
    }

    public static abstract class CollectionDomainEvent<T>
            extends PublishingModule.CollectionDomainEvent<PublishedEvent, T> {
    }

    public static abstract class ActionDomainEvent
            extends PublishingModule.ActionDomainEvent<PublishedEvent> {
    }
    //endregion
